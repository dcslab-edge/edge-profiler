...
class SparkGPUDataReceiverPythonDriver(BenchDriver):
    ...
    async def _launch_bench(self) -> asyncio.subprocess.Process:
        data_stream_path = BenchDriver.get_bench_home('data-stream-python')
        cmd = '{0}/bin/spark-submit {1}/receiver/sparkgpu_receiver_code.py'.format(self._bench_home, data_stream_path)
